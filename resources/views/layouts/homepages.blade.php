    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Top">
        <div class="w-full py-6 flex items-center justify-between border-b border-indigo-500 lg:border-none">
            ...
            <div class="ml-10 space-x-4">
                <a href="{{ route('signin') }}" class="inline-block bg-indigo-500 py-2 px-4 border border-transparent rounded-md text-base font-medium text-white hover:bg-opacity-75">Sign in</a>
        ...
        <div class="py-4 flex flex-wrap justify-center space-x-6 lg:hidden">
            ...
            <a href="https://www.facebook.com/valentino.jacinto" style="margin-left: 1em" class="text-base font-medium text-white hover:text-indigo-50"> Shop </a>
        </div>
    </nav>
</header>
...
<footer class="bg-white">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div class="mt-8 flex justify-center space-x-6">
            ...
            <a href="https://www.instagram.com/hippo_dt/" class="text-gray-400 hover:text-gray-500">
