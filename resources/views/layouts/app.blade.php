                            ...
                            <div>
                                <div class="px-2 space-y-1">
                                    ...
                                    <a href="{{ Route('myaccounttmp') }}"
                                       class="{{ Route::is(['account.myaccounttmp']) ? 'bg-gray-200 text-gray-900' : '' }}  hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                                    ...
                                    <!-- My QR -->
                                    <a href="{{ Route('myqr') }}"
                                       class="{{ Route::is(['account.templates']) ? 'bg-gray-200 text-gray-900' : '' }} hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a href="{{ Route('createqr') }}"
                                       class="{{ Route::is(['account.myqr']) ? 'bg-gray-200 text-gray-900' : '' }} hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md"
                                       aria-current="page">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             class="text-gray-400 group-hover:text-gray-500 mr-3 flex-shrink-0 h-6 w-6"
                                             fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    <!-- Shop -->
                                    <a href="{{ Route('shop') }}"
                                       class="{{ Route::is(['account.shop']) ? 'bg-gray-200 text-gray-900' : '' }} hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             class="text-gray-400 group-hover:text-gray-500 mr-3 flex-shrink-0 h-6 w-6"
                                             fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="px-2 space-y-1">
                                    ...
                                    <a href="{{ Route('helpaccount') }}"
                                       class="{{ Route::is(['account.help']) ? 'bg-gray-200 text-gray-900' : '' }} hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                                    ...
                                    <a href="{{ Route('settings') }}"
                                       class="{{ Route::is(['account.settings']) ? 'bg-gray-200 text-gray-900' : '' }} hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
