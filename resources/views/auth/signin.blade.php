...
@section('content')
    ...
    <div style="background-color: rgba(255,245,232,255)" class="h-screen w-screen overflow-hidden">
        <div class="relative bg-white "style="background-color: rgba(255,245,232,255); z-index: 3">
