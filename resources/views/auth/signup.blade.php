        ...
        <div class="h-screen flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div  class="mx-auto w-full max-w-sm lg:w-96">
                <div class="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <h2 class="text-center text-2xl font-extrabold text-gray-900">Sign up with your :</h2><br>
                    <p class="text-center text-1xl"><u>We will only send you one email</u></p>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-6">
                        <form class="space-y-6" action="{{ route('signup-post') }}" method="post">
                            {{ csrf_field() }}
                            <x-form.input :errors="$errors" label="Email" name="email" type="email" value="{{old('email')}}" />
                            ...
                            <div class="flex">
                                <a  href="{{route('signin')}}" class="flex">
                                    I already have an account, sign in<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
