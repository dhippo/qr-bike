            ...
            <div class="md:flex-1 md:mr-10">
              ...
              cool website
                ...
                <p class="font-pt-serif font-normal mb-7">
                    The purpose of our project is to offer a solution to athletes that would allow them to generate a QR
                    code in order to access their health data in case of emergency.
                    Thus, they will be able to print the generated QR code and find a way to stick it on their bike,
                    their helmet, their equipment.<br/><br/>
            ...
            <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 ">
                ...
                <dl class="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8 flex flex-col md:flex-row">
                    <div class="mx-8  ">
                        ...
                        <dd class="mt-2 text-base text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing
        ...
        <div class="">
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <p class="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">All
                        the information you need to make the most of our application.</p>
