...
@section('content')
    ...
    <main>
        <div class="pt-10 bg-brandcolor-third200 sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden"><!--bg-gray-900-->
            <div class="mx-auto max-w-7xl lg:px-8">
                <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                    <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                        <div class="lg:py-24">
                            <a href="{{route('contact')}}" class="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                                <span class="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-gradient-to-r from-teal-500 to-cyan-600 rounded-full">We're open to discussion</span>
                                <span class="ml-4 text-sm">Visit our contact page</span>
