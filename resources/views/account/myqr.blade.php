    ...
    @if($exist == 0)
        <div class="flex flex-col">
            ...
            <form class="flex justify-center" action="{{ route('createqr') }}">
                ...
                <button type="submit"
                        class="inline-flex items-center p-3 border border-transparent rounded-full shadow-sm text-white bg-kit-blue-dark hover:bg-kit-blue-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-kit-blue-dark">
                    <!-- ICON + -->
