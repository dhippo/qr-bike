    ...
    <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none xl:order-last">
        ...
        <article>
                ...
                <div style="width: 65vw; margin-left: 8vw" class="border-b border-gray-200">
                    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                            ...
                            <a href="#"
                               class="border-b-blue-900 text-gray-900 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm"
                               aria-current="page"> Profile </a>

                            <a href="#" style="margin-left: 17.5vw"
                               class="border-b-blue-900 text-gray-900 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                Health </a>

                            <a href="#" style="margin-left: 17vw"
                               class="border-b-blue-900 text-gray-900 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                Contact</a>
            ...
            <div style="width: 65vw; margin-left: 10vw" class="mt-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex">
                ...
                <dl style="margin-left: 17.5vw; width: 52px; min-width: 52px"
