...
@section('content')
    ...
    <div class="min-h-full flex">
                    ...
                    <div class="mt-6">
                        <form class="space-y-6" action="/signup" method="post">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input id="name" name="name" value="{{ old('name') }}" type="name" autocomplete="name" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    @if($errors->has('name'))
                            ...
                            <div class="flex">
                                <button type="submit" class="w-5/12 mr-auto  justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Sign up</button>
                                <a  href="/signin" class="w-5/12 text-center justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Sign in</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="hidden lg:block relative w-0 flex-1">
            <img class="absolute inset-0 w-full object-cover h-screen" src="{{URL::asset('/images/bike3.jpg')}}" alt="">
        </div>
    </div>
